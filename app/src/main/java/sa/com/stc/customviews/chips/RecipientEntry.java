...
public class RecipientEntry {
    ...
    private RecipientEntry(int entryType, String displayName, String destination,
        ...
        if (destination != null)
            mDestination = destination.replaceAll("[^0-9+]", "");
        else
            mDestination = "";
     ...
     */
    public static RecipientEntry constructFakePhoneEntry(final String phoneNumber, Uri photoThumbnailUri,
                                                         final boolean isValid) {
        return new RecipientEntry(ENTRY_TYPE_PERSON, phoneNumber, phoneNumber,
                INVALID_DESTINATION_TYPE, null, INVALID_CONTACT, null /* directoryId */,
                INVALID_CONTACT, photoThumbnailUri, true, isValid, null /* lookupKey */);
    }
