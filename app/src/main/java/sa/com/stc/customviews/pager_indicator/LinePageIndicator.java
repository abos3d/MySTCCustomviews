...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultStrokeWidth = res.getDimension(R.dimen.default_line_indicator_strokes_width);
        ...
        setStrokeWidth(a.getDimension(R.styleable.LinePageIndicator_strokesWidth, defaultStrokeWidth));
