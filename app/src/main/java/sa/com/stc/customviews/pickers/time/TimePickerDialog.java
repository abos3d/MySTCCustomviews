...
package sa.com.stc.customviews.pickers.time;
...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public TimePickerDialog() {
        ...
        mInitialHourOfDay = calendar.get(Calendar.HOUR);
    ...
    //return 24 hours format by default
    public int getmSelectHours() {
        return mTimePicker.getHours();
    }

    public int getmSelectMinutes() {
    ...
    public void updateListener(OnTimeSetListener callback) {
        mCallback = callback;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] amPmTexts = new DateFormatSymbols(Locale.ENGLISH).getAmPmStrings();
        mAmText = amPmTexts[0];
        mPmText = amPmTexts[1];
        ...
        if (okButtonListener != null)
            ...
            okButton.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    mCallback.onTimeSet(OK_BUTTON, mTimePicker.getHours(), mTimePicker.getMinutes());
                    dismiss();
                }
            });
        ...
        if (cancelButtonListener != null)
            ...
            defaultButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mCallback.onTimeSet(CANCEL_BUTTON, mCalendar.get(Calendar.HOUR_OF_DAY), mCalendar.get(Calendar.MINUTE));
                    dismiss();
                }
            });
        return view;
            ...
            if (mInKbMode) {
                if (!mTypedTimes.isEmpty()) {
                    ...
                    Utils.tryAccessibilityAnnounce(mTimePicker,
                            String.format(Locale.ENGLISH, mDeletedKeyFormat, deletedKeyStr));
                    updateDisplay(true);
                }
            }
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            String hourStr = (values[0] == -1) ? mDoublePlaceholderText :
                    String.format(Locale.ENGLISH, hourFormat, values[0]).replace(' ', mPlaceholderText);
            String minuteStr = (values[1] == -1) ? mDoublePlaceholderText :
                    String.format(Locale.ENGLISH, minuteFormat, values[1]).replace(' ', mPlaceholderText);
    ...
    public interface OnTimeSetListener {
        ...
        /**
         * @param clickedButtonType 0 if ok 1 if cancel
         * @param hourOfDay         The hour that was set.
         * @param minute            The minute that was set.
         */
        void onTimeSet(int clickedButtonType, int hourOfDay, int minute);
    }
